...
with open(
    "sugarPos_{}x{}_{}nm_vertical.csv".format(numRows, numColumns, volumeWidth), "w"
) as f:
    totalSugar = (
        ...
        for x in range(numRows):
            ...
            for z in range(numLayers):
                for i in range(6):
                    ...
                    ax.scatter(posSugar1_x, posSugar1_z, posSugar1_y, color="r")
                    ax.scatter(posSugar2_x, posSugar2_z, posSugar2_y, color="b")
                    ax.scatter(posBase1_x, posBase1_z, posBase1_y, color="g")
                    ax.scatter(posBase2_x, posBase2_z, posBase2_y, color="y")
...
with open(
    "histonePositions_{}x{}_{}nm_vertical.csv".format(numRows, numColumns, volumeWidth),
    "w",
) as f:
